...
let encodeUrl = encodeURI (argv.direccion) //enconteURI se utiliza para escapar a los espacios de la direccion
...
axios.get(`https://maps.googleapis.com/maps/api/geocode/json?address=${encodeUrl}+CA&key=AIzaSyAJ2aEs0UpGAW-G4mleFU6nasD6U1RkfT0`)
      .then(resp => {
        ...
        //console.log (JSON.strigsify(resp.data,undefined,2));
